...
//    public Reviews[] review=new Reviews[3];
    ...
    public void resetActivity(){
        int id = getResources().getIdentifier(movieName, "drawable", "com.sjsu.bookReview");
...
//                    reviews.add(review);
                    Log.i("test_child", String.valueOf(child));

                    movie=child.getValue(Book.class);
